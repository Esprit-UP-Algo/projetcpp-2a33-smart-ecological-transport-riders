...
client::client(int CIN,QString NOM,QString PRENOM ,QString MATRICULE ,QString DATEREN,QString MAIL,QString NB_PERMIS,QString MONTANT_TOTAL)
{
   this->CIN=CIN;
    this->NOM=NOM ;
    this->PRENOM=PRENOM;
...
QString client ::getMATRICULE(){return MATRICULE;}
QString client ::getDATEREN(){return DATEREN;}
QString client ::getMAIL(){return MAIL;}
QString client ::getNB_PERMIS(){return NB_PERMIS;}
QString client ::getMONTANT_TOTAL(){return MONTANT_TOTAL;}
//setters
...
void client::setMATRICULE(QString MATRICULE)
{this->MATRICULE=MATRICULE;}

void client::setDATEREN(QString DATEREN)
{this->DATEREN=DATEREN;}
void client::setMAIL(QString MAIL)
{this->MAIL=MAIL;}
void client::setNB_PERMIS(QString NB_PERMIS)
{this->NB_PERMIS=NB_PERMIS;}
void client::setMONTANT_TOTAL(QString MONTANT_TOTAL)
{this->MONTANT_TOTAL=MONTANT_TOTAL;}
...
bool client::modifier(int CIN, QString NOM, QString PRENOM, QString MATRICULE, QString DATEREN, QString MAIL, QString NB_PERMIS, QString MONTANT_TOTAL)
{
    QSqlQuery query;
...
QSqlQueryModel* client::rechercherCIN(int CIN)
{
    QSqlQueryModel * model= new QSqlQueryModel();
    QSqlQuery query;
